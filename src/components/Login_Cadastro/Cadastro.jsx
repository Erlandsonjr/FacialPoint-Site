...
function Cadastro() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.log(
        "Objeto horarioTrabalho:",
        JSON.stringify(horarioTrabalho, null, 2)
      );

      if (Object.keys(horarioTrabalho).length === 0) {
        throw new Error(
          "Objeto horarioTrabalho vazio - nenhum dia ativo foi configurado"
        );
      }
      ...
      console.log(
        ...
        JSON.stringify(
          {
            ...payload,
            foto: "[Array de codificação]",
            perfil: "[Imagem em base64]",
          },
          null,
          2
        )
  ...
  return (
    <div className="page-container">
      ...
      <div
        className={`container cadastro-container ${
